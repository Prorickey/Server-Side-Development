...
ReversiBlueprint = Blueprint('reversi', 'reversi')
...
@ReversiBlueprint.route('/game', methods=['GET', 'PUT'])
def gameOperations():
    """
    ...
    if request.method == 'GET':
        return send_file(os.path.join(bp_path, 'reversi.html'))
...
@ReversiBlueprint.route('/game', methods=['POST'])
def gameCreation():
    """
